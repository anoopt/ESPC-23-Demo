...
> Azure OpenAI API key. You can get a key from <https://platform.openai.com/account/api-keys>
...
- Update the `./azure-functions/local.settings.json` file with the Azure OpenAI API key, client ID and client secret
